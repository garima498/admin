      ...
      <div>
        ...
        <div className='flex gap-2'>
          <label htmlFor="image1">
            <img className='w-20'src={!image1 ? "" : URL.createObjectURL(image1)} alt="" />
            <input onChange={(e)=>setImage1(e.target.files[0])} type="file" id="image1" />
          </label>
          <label htmlFor="image2">
            <img className='w-20'src={!image2 ? "" : URL.createObjectURL(image2)} alt="" />
            <input onChange={(e)=>setImage2(e.target.files[0])} type="file" id="image2" />
          </label>
          <label htmlFor="image3">
            <img className='w-20'src={!image3 ? "" : URL.createObjectURL(image3)} alt="" />
            <input onChange={(e)=>setImage3(e.target.files[0])} type="file" id="image3" />
          </label>
          <label htmlFor="image4">
            <img className='w-20'src={!image4 ? "" : URL.createObjectURL(image4)} alt="" />
